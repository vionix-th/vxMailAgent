...
exports.TOOL_DESCRIPTORS = exports.OPTIONAL_TOOL_NAMES = exports.CORE_TOOL_NAMES = exports.TOOL_REGISTRY = void 0;
...
exports.CORE_TOOL_NAMES = exports.TOOL_REGISTRY.filter(t => t.category === 'mandatory').map(t => t.name);
exports.OPTIONAL_TOOL_NAMES = exports.TOOL_REGISTRY.filter(t => t.category === 'optional').map(t => t.name);
/**
 * Flags-based descriptors derived from the registry for selective tool exposure.
 */
exports.TOOL_DESCRIPTORS = exports.TOOL_REGISTRY.map((t) => ({
    name: t.name,
