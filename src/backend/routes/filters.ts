...
export default function registerFiltersRoutes(app: express.Express, deps: FiltersRoutesDeps) {
  ...
  app.get('/api/filters', (req, res) => {
    ...
    res.json(deps.getFilters(req as ReqLike));
  });
  ...
  app.post('/api/filters', (req, res) => {
    ...
    const next = [...deps.getFilters(req as ReqLike), filter];
    deps.setFilters(req as ReqLike, next);
  ...
  app.put('/api/filters/reorder', (req, res) => {
    ...
    const current = deps.getFilters(req as ReqLike);
    ...
    deps.setFilters(req as ReqLike, reordered);
