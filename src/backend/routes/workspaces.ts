...
export default function registerWorkspacesRoutes(app: express.Express, deps: WorkspacesRoutesDeps) {
  ...
  app.get('/api/workspaces/:id/items/:itemId', async (req, res) => {
  ...
  app.put('/api/workspaces/:id/items/:itemId', async (req, res) => {
    const { itemId } = req.params as { id: string; itemId: string };
  ...
  app.delete('/api/workspaces/:id/items/:itemId', async (req, res) => {
    const { itemId } = req.params as { id: string; itemId: string };
